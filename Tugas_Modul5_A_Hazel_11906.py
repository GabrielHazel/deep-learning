...
model_path = r'D:\perkuliahan\semester 5\PMDPM\Introduction to Deep Learning (Praktek)\best_model_tf.h5'
...
if os.path.exists(model_path):
    try:
        ...
        st.title("Fashion MNIST Image Classifier 1906")
        ...
        if uploaded_files:
            ...
            if predict_button:
                ...
                for file, image in zip(uploaded_files, images):
                    ...
                    st.sidebar.write(f"**File:** {file.name}")
